...
<div class="space-y-6">
    <div>
        ...
        <p class="page-subtitle">Input data buku baru untuk memperkaya koleksi perpustakaan.</p>
    </div>
        ...
        <form action="{{ route('books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-5">
            ...
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2">
                ...
                <div>
                    ...
                    <input id="pengarang" type="text" name="pengarang" value="{{ old('pengarang') }}" class="form-control" required>
                </div>

                <div>
                    <label for="penerbit" class="form-label">Penerbit</label>
                    <input id="penerbit" type="text" name="penerbit" value="{{ old('penerbit') }}" class="form-control" required>
                </div>

                <div>
                    <label for="isbn" class="form-label">ISBN</label>
                    <input id="isbn" type="text" name="isbn" value="{{ old('isbn') }}" class="form-control" required>
                </div>
                ...
                <div>
                    ...
                    <input id="tahun_terbit" type="number" name="tahun_terbit" value="{{ old('tahun_terbit') }}" class="form-control" required>
                </div>

                <div>
                    <label for="stok" class="form-label">Stok</label>
                    <input id="stok" type="number" name="stok" value="{{ old('stok') }}" class="form-control" required>
                </div>
                ...
                <div>
                    ...
                    <input id="lokasi" type="text" name="lokasi" value="{{ old('lokasi') }}" class="form-control">
                </div>
