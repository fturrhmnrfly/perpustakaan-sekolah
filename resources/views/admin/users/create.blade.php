...
<div class="space-y-6">
    <div>
        ...
        <p class="page-subtitle">Buat akun siswa baru untuk mengakses sistem peminjaman.</p>
    </div>
    ...
    <div class="section-card w-full">
        <form action="{{ route('users.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input id="no_identitas" type="text" name="no_identitas" value="{{ old('no_identitas') }}" class="form-control" required>
