...
<body>
    ...
    <div class="summary">
        <span>Total Peminjaman: <strong>{{ $borrowingsCount }}</strong></span>
        <span>Sedang Dipinjam: <strong>{{ $activeBorrowingsCount }}</strong></span>
        <span>Total Denda: <strong>Rp {{ number_format($totalFines, 0, ',', '.') }}</strong></span>
    </div>
